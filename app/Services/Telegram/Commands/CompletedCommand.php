...
class CompletedCommand implements TelegramCommandInterface
{
    ...
    public function execute(Message $message): void
    {
        ...
        $tasks = $this->taskService->getTasksList($user, 'completed');
        $formatted = $this->taskService->formatTasksList($tasks, 'Выполненные за сегодня');
